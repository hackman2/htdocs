...
__d('ExternalTrackingTag', ['AsyncSignal', 'Event', 'TrackingPixel'], (function a(b, c, d, e, f, g) {
    var h = {
        ...
        sendRequest: function i(j, k, l, m) {
            if (!j) return;
            new(c('AsyncSignal'))('/ads/external_tracking_tag/', {
                href: j,
                tracking_tag_id: k,
                adgroup_id: l,
                ad_id: m
...
__d('isLinkshimURI', ['isFacebookURI', 'isMessengerDotComURI'], (function a(b, c, d, e, f, g) {
    ...
    function h(i) {
        var j = i.getPath();
        if ((j === '/l.php' || j.indexOf('/si/ajax/l/') === 0 || j.indexOf('/l/') === 0 || j.indexOf('l/') === 0) && (c('isFacebookURI')(i) || c('isMessengerDotComURI')(i))) return true;
        return false;
    }
    f.exports = h;
}), null);
__d('FBLynxWrapper', ['URI', 'isFacebookURI', 'isLinkshimURI'], (function a(b, c, d, e, f, g) {
    ...
    var h = {
        ...
        isLynxLink: function i(j) {
            if (j.getAttribute('data-lynx-async-dest')) return true;
            if (j.getAttribute('data-lynx-uri')) return true;
            if (c('isLinkshimURI')(new(c('URI'))(j.href))) return true;
            return false;
        }
    };
    f.exports = h;
    ...
    var j = void 0,
        ...
        o = {
            init: function p(q, r, s, t) {
                ...
                l = q;
                k = t;
                if (!m) m = c('Arbiter').subscribe('ufi/didUpdate', function (u, v) {
                    if (v.offsetY) c('LitestandColumnManager').adjustVerticalWindowPosition(c('getScrollPosition')(window), v.offsetY);
                });
                c('Run').onLeave(function () {
                    m && m.unsubscribe();
                    m = null;
            ...
            canInsertNewerStories: function p() {
                if (c('ViewportBounds').getTop() > c('getElementPosition')(o.getStreamRoot()).y) return false;
                return c('LitestandStoryInsertionStatus').canInsert();
            },
            getFeedStreamID: function p() {
                return parseInt(c('nullthrows')(l).id.split('feed_stream_')[1], 16) % 1e+08;
            },
            isReady: function p() {
                return !!l;
            },
...
__d('FeedAdsClickLogger', ['Arbiter', 'AsyncRequest', 'Banzai', 'BanzaiODS', 'DataAttributeUtils', 'DOM', 'ExternalTrackingTag', 'FBLynxWrapper', 'LitestandMessages', 'LitestandStream', 'Parent', 'SLConfig', 'TrackingNodes', 'URI', 'collectDataAttributes', 'isFacebookURI', 'isLinkshimURI', 'ge'], (function a(b, c, d, e, f, g) {
    ...
    n.prototype.getStories = function () {
        'use strict';
        var p = c('LitestandStream').getStreamRoot();
        if (p) {
            return c('DOM').scry(p, c('LitestandStream').getStoriesSelector());
        } else {
            var q = c('ge')('home_stream');
            if (q) return c('DOM').scry(q, '.uiStreamStory');
        }
        return [];
    };
    ...
    n.prototype.getHref = function (p) {
        'use strict';
        return p.getAttribute && (p.getAttribute('ajaxify') || p.getAttribute('data-endpoint')) || p.action || p.href;
    };
...
__d('SLPerfTypedLogger', ['Banzai', 'GeneratedLoggerUtils', 'nullthrows'], (function a(b, c, d, e, f, g) {
    ...
    h.prototype.log = function () {
        c('GeneratedLoggerUtils').log('logger:SLPerfLoggerConfig', this.$SLPerfTypedLogger1, c('Banzai').BASIC);
    };
    h.prototype.logVital = function () {
        c('GeneratedLoggerUtils').log('logger:SLPerfLoggerConfig', this.$SLPerfTypedLogger1, c('Banzai').VITAL);
    };
    h.prototype.clear = function () {
        this.$SLPerfTypedLogger1 = {};
        return this;
    };
    h.prototype.updateData = function (j) {
        this.$SLPerfTypedLogger1 = babelHelpers['extends']({}, this.$SLPerfTypedLogger1, j);
        return this;
    };
    h.prototype.setCount = function (j) {
        this.$SLPerfTypedLogger1.count = j;
        return this;
    };
    h.prototype.setDurationMs = function (j) {
        this.$SLPerfTypedLogger1.duration_ms = j;
        return this;
    };
    h.prototype.setEvent = function (j) {
        this.$SLPerfTypedLogger1.event = j;
        return this;
    };
    var i = {
        count: true,
...
__d('SLUtils', ['csx', 'cx', 'Arbiter', 'DOM', 'Event', 'FeedAdsClickLogger', 'LitestandMessages', 'LitestandStream', 'Map', 'SLConfig', 'SLPerfTypedLogger', 'URI', 'clearTimeout', 'curry', 'cxodecode', 'goURI', 'joinClasses', 'setIntervalAcrossTransitions', 'setTimeoutAcrossTransitions'], (function a(b, c, d, e, f, g, h, i) {
    ...
    function k(ra, sa) {
        ...
        l();
        if (c('SLConfig').gk.sl_replace_about_link) q(function (ua, va) {
            return r(ua, va);
        });
    ...
    function n() {
        ...
        if (ua) {
            m = c('setTimeoutAcrossTransitions')(n, c('SLConfig').sv.sl_content_waiting_delay);
            if (ka()) ma().setEvent('hsa_waiting_for_content').log();
        }
    ...
    function r(ra, sa) {
        var ta = x(ra, sa);
        if (!ta) {
            if (ka()) ma().setEvent('usl_real_subtitle_missing').log();
            return;
        }
        var ua = c('DOM').scry(ta, 'a'),
            va = ua.filter(function (wa) {
                var xa = new(c('URI'))(wa.href).getPath();
                return xa === '/ads/about' || xa === '/about/ads';
            });
    ...
    function y(ra, sa) {
        ...
        var ta = fa();
        if (!ta) {
            if (ka()) ma().setEvent('es_subtitle_container_missing').log();
            return;
        }
    ...
    function z(ra) {
        ...
        var sa = ia();
        if (!sa) {
            if (ka()) ma().setEvent('usp_feed_root_missing').log();
            return;
        }
        var ta = w.get(ra);
        if (!ta) {
            if (ka()) ma().setEvent('usp_fake_missing').log();
            return;
        }
        var ua = v.get(ra);
        if (!ua) {
            if (ka()) ma().setEvent('usp_real_missing').log();
            return;
        }
...
__d('UFIOrderingModeSelector.react', ['cx', 'invariant', 'ix', 'Image.react', 'InlineBlock.react', 'Link.react', 'PopoverMenu.react', 'React', 'ReactXUIMenu'], (function a(b, c, d, e, f, g, h, i, j) {
    ...
    function o() {
        ...
        return q = (p = l.constructor).call.apply(p, [this].concat(s)), this.onMenuItemClick = function (u, v) {
            this.props.onOrderChanged(v.item.getValue());
        }.bind(this), q;
    }
    o.prototype.render = function () {
        if (this.props.orderingModes.length === 0) return null;
        var p = this.props.orderingModes.filter(function (r) {
            return r.value == this.props.selectedMode;
        }.bind(this)).map(function (r) {
            return r.name;
        }).pop();
        p || i(0);
        var q = c('React').createElement(m, {
            className: "_4tju",
            onItemClick: this.onMenuItemClick
        }, this.props.orderingModes.map(function (r) {
            return c('React').createElement(n, {
                key: r.value,
                value: r.value,
                label: r.name,
                selected: r.value === this.props.selectedMode
            }, c('React').createElement('div', {
                className: "_3scm"
            }, c('React').createElement('div', {
                className: "_3scn"
            }, r.name), c('React').createElement('div', {
                className: "_3sco"
            }, r.description)));
        }.bind(this)));
        return c('React').createElement('div', {
            ...
            menu: q,
            alignh: 'right'
        }, c('React').createElement(c('Link.react'), null, p, c('React').createElement(c('Image.react'), {
            className: "_3sct",
            src: j("101460")
        })))));
    };
...
__d('CommentsOrderingModeSelectorUsageTypedLogger', ['Banzai', 'GeneratedLoggerUtils', 'nullthrows'], (function a(b, c, d, e, f, g) {
    ...
    h.prototype.log = function () {
        c('GeneratedLoggerUtils').log('logger:CommentsOrderingModeSelectorUsageLoggerConfig', this.$CommentsOrderingModeSelectorUsageTypedLogger1, c('Banzai').BASIC);
    };
    h.prototype.logVital = function () {
        c('GeneratedLoggerUtils').log('logger:CommentsOrderingModeSelectorUsageLoggerConfig', this.$CommentsOrderingModeSelectorUsageTypedLogger1, c('Banzai').VITAL);
    };
    h.prototype.clear = function () {
    ...
    h.prototype.updateData = function (j) {
        this.$CommentsOrderingModeSelectorUsageTypedLogger1 = babelHelpers['extends']({}, this.$CommentsOrderingModeSelectorUsageTypedLogger1, j);
        return this;
    };
    h.prototype.setAvailableOrders = function (j) {
        this.$CommentsOrderingModeSelectorUsageTypedLogger1.available_orders = c('GeneratedLoggerUtils').serializeVector(j);
        return this;
    };
    h.prototype.setEndOrder = function (j) {
        this.$CommentsOrderingModeSelectorUsageTypedLogger1.end_order = j;
        return this;
    };
    h.prototype.setPostFbid = function (j) {
        this.$CommentsOrderingModeSelectorUsageTypedLogger1.post_fbid = j;
        return this;
    };
    h.prototype.setPostOwnerFbid = function (j) {
        this.$CommentsOrderingModeSelectorUsageTypedLogger1.post_owner_fbid = j;
        return this;
    };
    h.prototype.setStartOrder = function (j) {
        this.$CommentsOrderingModeSelectorUsageTypedLogger1.start_order = j;
        return this;
    };
    h.prototype.setVC = function (j) {
        this.$CommentsOrderingModeSelectorUsageTypedLogger1.vc = j;
        return this;
    };
    var i = {
...
__d('UFIOrderingModeSelectorContainer.react', ['CommentsOrderingModeSelectorUsageTypedLogger', 'Random', 'React', 'SubscriptionsHandler', 'UFIConfig', 'UFIInstanceAction', 'UFIOrderingModeSelector.react', 'UFIOrderingModeStore', 'UFISharedDispatcher'], (function a(b, c, d, e, f, g) {
    ...
    function k() {
        ...
        return m = (l = i.constructor).call.apply(l, [this].concat(o)), this.state = {
            selectedMode: c('UFIOrderingModeStore').getState().get(this.props.contextArgs.instanceid)
            ...
            if (r.orderingmodes && c('UFIConfig').logChangeOrderingModeUsageSampleRate > c('Random').random()) {
                var s = r.orderingmodes.map(function (t) {
                    return t.value;
                });
    ...
    k.propTypes = {
        ...
        contextArgs: j.object.isRequired
    };
    f.exports = k;
}), null);
    ...
    var j = 2,
        ...
        l = {
            ...
            loadMapAttachment: function m(n, o, p) {
                ...
                if (!r) return;
                c('tidyEvent')(c('Event').listen(q, 'click', function () {
                    c('Arbiter').inform(c('AttachmentRelatedShareConstants').MAP_CLICK, {
                        attachment: r,
                        story_id: p
                    });
                }));
            ...
            loadMapAttachmentActionButton: function m(n, o) {
                ...
                if (!p) return;
                c('tidyEvent')(c('Event').listen(p, 'click', function () {
                    c('Arbiter').inform(c('AttachmentRelatedShareConstants').ACTION_BUTTON_CLICK, {
                        button: p,
                        story_id: o
                    });
                }));
...
__d('CtaImpressionsTypedLogger', ['Banzai', 'GeneratedLoggerUtils', 'nullthrows'], (function a(b, c, d, e, f, g) {
    ...
    h.prototype.log = function () {
        c('GeneratedLoggerUtils').log('logger:CtaImpressionsLoggerConfig', this.$CtaImpressionsTypedLogger1, c('Banzai').BASIC);
    };
    h.prototype.logVital = function () {
        c('GeneratedLoggerUtils').log('logger:CtaImpressionsLoggerConfig', this.$CtaImpressionsTypedLogger1, c('Banzai').VITAL);
    };
    h.prototype.clear = function () {
        this.$CtaImpressionsTypedLogger1 = {};
        return this;
    };
    h.prototype.updateData = function (j) {
    ...
    h.prototype.setCtaType = function (j) {
        this.$CtaImpressionsTypedLogger1.cta_type = j;
        return this;
    };
    h.prototype.setOriginalURI = function (j) {
        this.$CtaImpressionsTypedLogger1.original_uri = j;
        return this;
    };
    ...
    var h = 150,
        ...
        j = {
            show: function k(l, m, n, o) {
                ...
                function r(s, t, u) {
                    new(c('Animation'))(s).to(t, u).duration(h).ease(c('Animation').ease.both).go();
                }
            }
        };
    f.exports = j;
...
__d('FbFeedAccessible', ['csx', 'fbt', 'invariant', 'AccessibilityConfig', 'Arbiter', 'ARIA', 'BootloadedComponent.react', 'CSS', 'DataAttributeUtils', 'DOMQuery', 'JSResource', 'LitestandMessages', 'React', 'ReactDOM', 'SubscriptionsHandler', 'ge', 'getOrCreateDOMID'], (function a(b, c, d, e, f, g, h, i, j) {
    var k = 'Accessibility/StoriesRequested',
        ...
        q = {
            ...
            setARIARole: function r(s) {
                s.setAttribute('role', 'article');
            },
            setAriaLabelledBy: function r(s) {
                if (s.getAttribute('aria-labelledby')) return;
                var t = this._filterForElement(s, ["._5pbw"]);
                if (t.length > 0) s.setAttribute('aria-labelledby', t.map(function (u) {
                    return c('getOrCreateDOMID')(u);
                }).join(' '));
            },
            setAriaDescribedBy: function r(s) {
                if (s.getAttribute('aria-describedby')) return;
                var t = this._filterForElement(s, [".timestampContent", "._5pbx"]);
                if (t.length > 0) s.setAttribute('aria-describedby', t.map(function (u) {
                    return c('getOrCreateDOMID')(u);
                }).join(' '));
            },
            _getStories: function r(s) {
                return c('DOMQuery').scry(s || o, "._5jmm");
            },
            _onInsertedSubstream: function r(s, t) {
                if (t && t.substream_id) c('Arbiter').inform(n, t.substream_id);
            },
            ...
            _processStoriesLoaded: function r() {
                c('ARIA').notify(i._("Der er indl\u00e6st flere historier ."));
            },
            _processStoriesRequested: function r() {
                c('ARIA').notify(i._("Der er anmodet om flere historier."));
            },
            ...
            _filterForElement: function r(s, t) {
                return t.map(function (u) {
                    return c('DOMQuery').scry(s || document, u)[0];
                }).filter(function (u) {
                    return !!u;
                });
            }
