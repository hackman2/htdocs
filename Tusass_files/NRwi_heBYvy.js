if (self.CavalryLogger) {
    CavalryLogger.start_js(["tlQU8"]);
}

__d("TimelineAppSectionConstants", [], (function a(b, c, d, e, f, g) {
    f.exports = {
        collectionTabKeyToAppTabKey: {
            ...
            video_tv_shows_watch: "tv",
            music_saved: "music",
            video_movies_want: "movies",
            video_tv_shows_want: "tv",
            video_movies_favorite: "movies",
            video_tv_shows_favorite: "tv",
            ...
            apps_used: "games",
            games_play: "games",
            games_apps_saved: null,
            video_movies_suggestions: null,
            video_tv_shows_suggestions: null,
            books_suggestions: null,
            saved_books: "saved",
            saved_movies: "saved",
            saved_tv_shows: "saved",
            saved_music: "saved",
            places_saved: "map",
            saved_links: "saved",
            sports_teams: "sports",
            ...
            saved_places: "saved",
            saved_all: "saved",
            sports_athletes: "sports",
            sports_activities: null,
            saved_events: "saved",
            saved_archived: "saved",
            places_recent: "map",
            places_visited: "map",
            reviews_written: "reviews",
            likes_section_movies: "likes",
            likes_section_tv_shows: "likes",
            likes_section_books: "likes",
            likes_section_music: "likes",
            likes_section_sports_teams: "likes",
            place_visits_by_place_tag: null,
            places_cities: "map",
            place_visits_by_city: null,
            topic_visit_counts: "map",
            place_visits_by_topic: null,
            place_visit_stories: null,
            places_map: "map",
            likes_section_apps_and_games: "likes",
            likes_section_sports_athletes: "likes",
            places_cities_desktop: "map",
            saved_videos: "saved",
            saved_pages: "saved",
            friends_with_upcoming_birthdays: "friends",
            friends_current_city: "friends",
            friends_hometown: "friends",
            at_work_contact: null,
            place_reviews_written: "reviews",
            movie_reviews_written: "reviews",
            tv_show_reviews_written: "reviews",
            book_reviews_written: "reviews",
            photos_all_expanded: "photos",
            videos_by_user: "videos",
            videos_user_tagged: "videos",
            friends_map: "friends",
            videos_user_all: "videos",
            saved_posts: "saved",
            saved_photo_posts: "saved",
            saved_products: "saved",
            at_work_hr_info: null,
            friends_with_unseen_posts: "friends",
            groups_mutual: "groups",
            saved_profiles: "saved",
            work_followers: "friends",
            work_following: "friends",
            saved_messages: "saved",
            saved_lists: "saved",
            saved_fundraisers: "saved",
            video_playlists: "videos",
            saved_jobs: "saved",
            lists: "lists",
            list_contents: "lists",
            saved_group_posts: "saved",
            saved_offers: "saved",
            albums_all: "albums_all",
            albums_featured: "albums_all",
            tasks_created: "tasks",
...
__d("XBasicFBNuxViewController", ["XController"], (function a(b, c, d, e, f, g) {
    f.exports = c("XController").create("\/ajax\/megaphone\/view_fbnux\/", {
        nux_id: {
            type: "Int",
            required: true
        }
...
__d('FileInputUploader', ['ArbiterMixin', 'DOM', 'DTSG', 'FileForm', 'Form', 'mixin'], (function a(b, c, d, e, f, g) {
    ...
    j.prototype._onFileFormEvent = function (k, l) {
        'use strict';
        if (k === 'success' || k === 'failure') this._destroyFileForm();
...
__d('XReferer', ['Base64', 'Cookie', 'FBJSON', 'URI', 'setTimeoutAcrossTransitions'], (function a(b, c, d, e, f, g) {
    var h = {
        update: function i(j, k, l) {
            ...
            if (j != null) c('setTimeoutAcrossTransitions')(function () {
                if (j != null) h._setCookie(j, m, o);
            }, 0);
        },
        ...
        truncatePath: function i(j) {
            var k = 1024;
            if (j && j.length > k) j = j.substring(0, k) + '...';
            return j;
        }
    };
    f.exports = h;
        ...
        init: function i() {
            ...
            if (window.history && history.pushState) {
                ...
                try {
                    ...
                    if (!(l.number === -2147467259)) throw l;
                }
    ...
    var p = {
        ...
        _handleTransition: function q(r) {
            ...
            if (p._transitions_disabled || !r.isSameOrigin()) {
                c('PageNavigationStageLogger').setNote('pt_disabled');
                return false;
            }
            var s = c('PageTransitionsConfig').reloadOnBootloadError && this._hasBootloadErrors();
            if (s) {
                c('PageNavigationStageLogger').setNote('bl_err');
                return false;
            }
        ...
        _warnBeforeLeaving: function q(r, s) {
            c('Bootloader').loadModules(["DialogX", "XUIDialogTitle.react", "XUIDialogBody.react", "XUIDialogButton.react", "XUIDialogFooter.react", "XUIGrayText.react"], function (t, u, v, w, x, y) {
                ...
                }, i._("Forlad side?")), c('React').createElement(v, null, c('React').createElement(y, {
                    shade: 'medium',
                    size: 'medium'
                }, r)), c('React').createElement(x, null, c('React').createElement(w, {
                    action: 'cancel',
                    label: i._("Bliv p\u00e5 denne side")
                }), c('React').createElement(w, {
                    action: 'confirm',
                    use: 'confirm',
                    label: i._("Forlad denne side")
                }))));
    ...
    var h = {
        ...
        goToProfileID: function i(j) {
            if (c('BizSiteIdentifier.brands').isBizSite()) {
                c('goURI')(c('BusinessURI.brands')('/profile.php').addQueryData('id', j), true);
            } else c('goURI')(new(c('URI'))('/' + j), true);
        },
        ...
        getSectionKeyFromURI: function i(j) {
            return j.getQueryData().sk || j.getPath().split('/')[2] || c('ProfileTabConst').TIMELINE;
        },
        ...
        isVideoPermalink: function i(j) {
            return h.getTabKeyFromURI(j) === c('ProfileTabConst').VIDEOS && j.getPath().split('/').filter(function (k) {
                return !!k;
            }).length > 2;
        }
    };
...
__d('StrSet', [], (function a(b, c, d, e, f, g) {
    ...
    h.prototype.contains = function (i) {
        'use strict';
        return Object.prototype.hasOwnProperty.call(this.$StrSet2, i);
    };
